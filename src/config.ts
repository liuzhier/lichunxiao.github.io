...
export const siteConfig: SiteConfig = {
	title: "Li Chunxiao's Blog",
	subtitle: "Pal - The Library of Classics",

	lang: SITE_LANG,

	themeColor: {
		hue: 15, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	banner: {
		...
		homeText: {
			...
			title: "蜀山　藏经图库", // 主页横幅主标题

			subtitle: [
				"诸位仙友请留步～　此处乃我蜀山藏经图库。",
				"您可在此查阅经典游戏《仙剑奇侠传》的相关古籍。",
			], // 主页横幅副标题，支持多文本
			typewriter: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// 		{
		// 			name: "Bilibili",
		// 			url: "https://space.bilibili.com/678783733",
		// 			external: true,
		// 			icon: "fa6-brands:bilibili",
		// 		},
		// 		{
		// 			name: "Gitee",
		// 			url: "https://gitee.com/liuzhier",
		// 			external: true,
		// 			icon: "mdi:git",
		// 		},
		// 	],
